...
def handle_data():
    ...
    return render_template("detail.html", lat=lat, lng=lng, population = population, suburb = json.dumps(suburb), cultural_diversity = cultural_diversity, age_diversity = age_diversity)
